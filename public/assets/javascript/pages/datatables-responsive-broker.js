  ...
  _createClass(DataTablesResponsiveDemo, [{
    ...
    value: function table() {
      $('#dt-responsive').DataTable({
        ajax: 'assets/data/waste_broker.json',
        //ajax: 'http://localhost/apleonawaste/assets/data/waste_broker.json',
        responsive: true,
        ...
        columns: [{
          ...
          data: 'waste_broker_name'
        }, {
          data: 'waste_broker_country'
        }],
       columnDefs: [{
        targets: 0,
