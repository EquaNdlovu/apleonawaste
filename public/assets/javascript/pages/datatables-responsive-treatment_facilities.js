  ...
  _createClass(DataTablesResponsiveDemo, [{
    ...
    value: function table() {
      $('#dt-responsive').DataTable({
        ajax: 'assets/data/treatment_facilities.json',
        //ajax: 'http://localhost/apleonawaste/assets/data/treatment_facilities.json',
        responsive: true,
        ...
        columns: [{
          ...
          data: 'treatment_facility_name'
        }, {
          data: 'treatment_facility_country'
        }],
       columnDefs: [{
        targets: 0,
        render: function render(data, type, row, meta) {
          return "<button type=\"button\" class=\"btn btn-primary editbtn\" data-toggle=\"modal\" data-target=\"#updateModal\"><i class=\"fa fa-pencil-alt\"></i></button>\n     <a class=\"btn btn-secondary\" href=\"treatments/delete/".concat(data, "\" onclick=\"confirmation(event)\"><i class=\"far fa-trash-alt\"></i></a>");
        },
        }]
      });
    }
