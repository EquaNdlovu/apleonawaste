  ...
  _createClass(DataTablesResponsiveDemo, [{
    ...
    value: function table() {
      $('#dt-responsive').DataTable({
        ajax: 'assets/data/treatment_facility_certificates.json',
        //ajax: 'http://localhost/apleonawaste/assets/data/treatment_facility_certificates.json',
        responsive: true,
        ...
        order: [1, 'desc'],
        columns: [{
          data: 'treatment_facility_certificates_key',
          orderable: false,
          searchable: false
        }, {
          data: 'treatment_facility_certificates_facility_key'
        }, {
          data: 'treatment_facility_certificates_date'
        }, {
          data: 'files',
          ...
          data: 'treatment_facility_certificates_country'
       //}
      //  , {
      //   data: 'Status',
      //   render: function(data, type) {
      ...
      // }
       ...
       columnDefs: [{
        ...
        render: function render(data, type, row, meta) {
          return "<a class=\"btn btn-sm btn-icon btn-secondary\" href=\"Treatment_Facility_Certificates/edit/".concat(data, "\"><i class=\"fa fa-pencil-alt\"></i></a>\n");
        },
        }]
      });
    }
