  ...
  _createClass(DataTablesResponsiveDemo, [{
    ...
    value: function table() {
      $('#dt-responsive').DataTable({
        ajax: 'assets/data/customers.json',
        ...
        order: [2, 'desc'],
        columns: [{
          data: 'waste_customer_key',
          orderable: false,
          searchable: false
        }, {
          data: 'waste_customer_country'
        }, {
          data: 'waste_customer_name'
        }],
       columnDefs: [{
        targets: 0,
        render: function render(data, type, row, meta) {
          return "<a class=\"btn btn-sm btn-icon btn-secondary\" href=\"customers/edit/".concat(data, "\"><i class=\"fa fa-pencil-alt\"></i></a>\n");
        },
        }]
      });
    }
