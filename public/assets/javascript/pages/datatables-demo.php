    ...
    value: function table2() {
      $('#myTable2').DataTable({
        ...
        columnDefs: [{
          ...
          targets: 5,
          render: function render(data, type, row, meta) {
            return "<a class=\"btn btn-sm btn-icon btn-secondary\" href=\"localhost/apleonawaste/collections/edit.php".concat(data, "\"><i class=\"fa fa-pencil-alt\"></i></a>\n          <a class=\"btn btn-sm btn-icon btn-secondary\" href=\"#").concat(data, "\"><i class=\"far fa-trash-alt\"></i></a>");
          }
        }]
      });
    }
