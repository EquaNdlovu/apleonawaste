      ...
      <div class="page-inner">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="optionModalLabel">Add Charity</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form action="<?php echo URLROOT; ?>/Lookup_Charities/add" method="post">
        ...
        <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Edit Charity</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form action="<?php echo URLROOT; ?>/Lookup_Charities/update" method="post">
                  <div class="form-group" style="display:none">
          ...
          <?php foreach ($data['lookup'] as $lookups) :
            if (($lookups->customer) == $_SESSION['customer_group']) { ?>
              <tr>
                ...
                <td style="text-align: center"><a type="button" class="btn btn-secondary" href="<?php echo URLROOT; ?>/Lookup_Charities/delete/<?php echo $lookups->lookup_key; ?>" onclick="confirmation(event)">Delete</a></td>
              </tr>
          <?php }
          endforeach; ?>
        </table>
