...
?>
 ...
 <!-- .app-main -->
  ...
  <div class="card card-body bg-light mt-5">
    <h2>Edit Waste Producers</h2>
    <form action="<?php echo URLROOT; ?>/Waste_Producers/edit/<?php echo $data['waste_producer_key']; ?>" method="post">
        ...
        <div class="form-group">
            ...
            <?php
                ...
                $result = mysqli_query($db, $sql);
                 echo "<option value='" .$data['waste_producer_customer']."']> ".$data['waste_producer_customer']. "</option>";
