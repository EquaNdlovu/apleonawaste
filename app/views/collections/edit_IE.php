                  ...
                  <div id="stepper" class="bs-stepper">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        action="<?php echo URLROOT; ?>/collections/edit_IE/<?php echo $data['collections_key']; ?>" method="post" enctype="multipart/form-data">
                          ...
                          <div id="test-l-1" class="content dstepper-none fade">
                            ...
                            <fieldset>
                              ...
                              <div class="d-flex">
                              <p></p><input type="submit" class="btn btn-success" value="Save"><button type="button" class="next btn btn-primary ml-auto" data-validate="fieldset01">Next step</button>
                              </div><!-- /.d-flex -->
                              <br><br>
                              ...
                              <select name="collections_customer_country" id="collections_customer_country" data-toggle="selectpicker" data-width="100%" onChange='getCustomer(this.value);'>
                              <?php
                              ...
                              <div class="form-group mb-4">
                                <div class="form-label-group">
                                  ...
                                  <input type="text" id="collections_workorder" name="collections_workorder" class="form-control" autocomplete="off" data-parsley-group="fieldset01" value="<?php echo $data['collections_workorder']; ?>">
                                </div>
                            ...
                            <div class="form-group mb-4">
                               ...
                               <select id="collections_customer_number" name="collections_customer_number" data-toggle="selectpicker" data-width="100%" onChange='getCustomerGroup(this.value); getCustomerSite(this.value); getWasteProducer(this.value); getCustomerAddress(this.value); makeFreeText();'>
                                 <?php
                                 $db = mysqli_connect('46.22.129.7', 'apl_waste_user', 'Upl5o73?', 'apleona_waste');
                   ...
                   <div id="test-l-2" class="content dstepper-none fade">
                      ...
                      <fieldset>
                        ...
                        <div class="d-flex">
                        <!-- style="margin:auto" -->
                            <button type="button" class="prev btn btn-secondary">Previous</button><input type="submit" class="btn btn-success" value="Save"> <button type="button" class="next btn btn-primary ml-auto" data-validate="fieldset02">Next step</button>
                        </div>
                        <br><br>
                        ...
                        <div class="row" style="display:none">
                          ...
                          <div class="ml-3">
                            ...
                            <label class="d-block">Please check the box if waste is hazardous</label>
                              ...
                              <input type="checkbox" class="custom-control-input" id="hazardous_checkbox" name="hazardous_checkbox" onchange="showHazardousCheckboxFields()" <?php if($data['hazardous_checkbox'] == 'on') echo 'checked="checked"';?>><label class="custom-control-label" for="hazardous_checkbox"></label>
                            </div>
                            </div>
                          </div><!-- /grid column -->
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-4" id="IE_MD">
                            <div class="form-group">
                              ...
                              $result = mysqli_query($db, $sql);
                              echo "<option value='" . $data['Material_Description'] . "'>". $data['Material_Description'] . "</option>";
                        ...
                        <div class="col-md-6 mb-4" id="IE_MAD">
                            <div class="form-group">
                              ...
                              <select id="Material_Detail" name="Material_Detail" class="selectpicker" data-live-search="true" data-width="100%" data-size="6" data-parsley-group="fieldset02" value="">
                              <?php
                              $db = mysqli_connect('46.22.129.7', 'apl_waste_user', 'Upl5o73?', 'apleona_waste');
                              $sql = "SELECT description FROM lookup_material_analysis_detail WHERE customer = '" . $_SESSION['customer_group'] . "'";
                              $result = mysqli_query($db, $sql);
                              echo "<option value='" . $data['Material_Detail'] . "'>". $data['Material_Detail'] . "</option>";
                              echo "<option value=0>Please Select</option>";
                              while ($row = mysqli_fetch_array($result)) {
                                echo "<option value='" . $row['description'] . "'> " . $row['description'] . "</option>";
                              }
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                              ...
                              <select id="Material_Class" name="Material_Class" class="selectpicker" data-live-search="true" data-width="100%" data-size="6" data-parsley-group="fieldset02" value="" onchange="showHazardousWasteFields()">
                              <?php
                              $db = mysqli_connect('46.22.129.7', 'apl_waste_user', 'Upl5o73?', 'apleona_waste');
                              $sql = "SELECT description FROM lookup_material_class WHERE customer = '" . $_SESSION['customer_group'] . "'";
                              $result = mysqli_query($db, $sql);
                              echo "<option value='" . $data['Material_Class'] . "'>". $data['Material_Class'] . "</option>";
                              echo "<option value=''>Please Select</option>";
                              while ($row = mysqli_fetch_array($result)) {
                                echo "<option value='" . $row['description'] . "'> " . $row['description'] . "</option>";
                              }
                          ...
                          <!-- grid column -->
                            <div class="col-md-6 mb-4">
                              ...
                              <?php
                                echo "<option value=" . $data['Indication_of_Danger'] . ">". $data['Indication_of_Danger'] . "</option>";
                              ?> 
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 mb-4" style="display:none">
                            <div class="form-label-group">
                              <input type="text" id="Material_Description_Alt" class="form-control" name="Material_Description_Alt" data-parsley-group="fieldset02" value="<?php echo $data['Material_Description_Alt']; ?>"> <label for="Material_Description_Alt">Material Description (Free Text)</label>
                            </div>
                            <div class="invalid-feedback"> Valid Material Description is required. </div>
                          </div><!-- /grid column -->
                          <!-- grid column -->
                          <div class="col-md-6 mb-4" style="display:none">
                            <div class="form-label-group">
                              <input type="text" id="Material_Detail_Alt" class="form-control" name="Material_Detail_Alt" data-parsley-group="fieldset02" value="<?php echo $data['Material_Detail_Alt']; ?>"> <label for="Material_Detail_Alt">Material Detail (Free Text)</label>
                            </div>
                            <div class="invalid-feedback"> Valid Material Detail is required. </div>
                          </div><!-- /grid column -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                              <select name=ewc_parent id=ewc_parent data-toggle="selectpicker" data-live-search="true" data-width="100%" data-size="6" onchange="getChildEWC(this.value); showHazardousFields();">
                                <?php
                                $db = mysqli_connect('46.22.129.7', 'apl_waste_user', 'Upl5o73?', 'apleona_waste');
                                $sql = "SELECT * FROM ewc_codes_updated WHERE LENGTH(ewc_numeric_id) > 5 ORDER BY ewc_key ASC";
                                $result = mysqli_query($db, $sql);
                                echo "<option value='" . $data['ewc_parent'] . "'> " . $data['ewc_parent'] . "</option>";
                                while ($row = mysqli_fetch_array($result)) {
                          ...
                          <div class="col-md-6 mb-4">
                              ...
                              <div class="input-group">
                                ...
                                <?php
                                  echo "<option value=" . $data['ewc_sub'] . ">". $data['ewc_sub'] . "</option>";
                                ?> 
                                </select>
                              </div>
                            </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 mb-4">
                            ...
                            <div class="form-label-group">
                              <input type="number" value="<?php echo $data['Quantity']; ?>" step=".01" id="Quantity" class="form-control" name="Quantity" data-parsley-group="fieldset02" required=""> <label for="Quantity">Quantity - Weights</label>
                            </div>
                          ...
                          <div class="col-md-6 mb-4">
                            <div class="form-label-group">
                              <!-- <input type="text" id="Unit_of_Measure" class="form-control" name="Unit_of_Measure" value="<?php echo $data['Unit_of_Measure']; ?>" data-parsley-group="fieldset02"> <label for="Unit_of_Measure">Unit of Measure</label> -->
                              <label class="control-label" for="Unit_of_Measure">Unit of Measure</label>
                              <select id="Unit_of_Measure" name="Unit_of_Measure" class="form-control" autocomplete="off" data-parsley-group="fieldset02" value="<?php echo $data['Unit_of_Measure']; ?>">
                              <?php
                                echo "<option value='" . $data['Unit_of_Measure'] . "'>". $data['Unit_of_Measure'] . "</option>";
                              ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 mb-4">
                            <div class="form-label-group">
                              <input type="number" value="<?php echo $data['collections_quantity_not_kg']; ?>" step=".01" id="collections_quantity_not_kg" class="form-control" name="collections_quantity_not_kg" data-parsley-group="fieldset02" required=""> <label for="collections_quantity_not_kg">Quantity other than Weight (UN,PC,AU,Pallet,HR)</label>
                            </div>
                            <div class="invalid-feedback"> Valid Quantity is required. </div>
                          </div><!-- /grid column -->
                          ...
                          <div class="col-md-6 mb-4">
                            <div class="form-label-group">
                              <input type="text" id="collections_not_kg_UOM" class="form-control" name="collections_not_kg_UOM" data-parsley-group="fieldset02" value="<?php echo $data['collections_not_kg_UOM']; ?>"> <label for="collections_not_kg_UOM">Unit of Measure</label>
                            </div>
                        ...
                        <div class="row">
                          <!-- grid column -->
                          <div class="col-md-6 mb-4"  id="Material_Packaging_div">
                            <div class="form-label-group">
                              <input type="text" id="Material_Packaging_Group" class="form-control" name="Material_Packaging_Group" value="<?php echo $data['Material_Packaging_Group']; ?>" data-parsley-group="fieldset02"> <label for="Material Packaging Group">Material Packaging Group</label>
                            </div>
                          ...
                          <div class="col-md-6 mb-4" id="Material_UN_Code_div" style="display:none">
                            <div class="form-label-group">
                              <input type="text" id="Material_UN_Code" class="form-control" name="Material_UN_Code" data-parsley-group="fieldset02" value="<?php echo $data['Material_UN_Code']; ?>"><label for="Material_UN_Code">Material UN Code</label>
                            </div>
                        ...
                        <?php } ?>
                                  <div class="form-label-group">
                                    <input type="text" id="Container_Quantity" class="form-control" name="Container_Quantity" value="<?php echo $data['Container_Quantity']; ?>" data-parsley-group="fieldset04"> <label for="Container_Quantity">Packaging Container Units</label>
                                  </div>
                                ...
                                <div class="col-md-6 mb-4">
                                  <div class="form-label-group">
                                  <input type="text" id="Container_Type" class="form-control" name="Container_Type" value="<?php echo $data['Container_Type']; ?>" data-parsley-group="fieldset04"> <label for="Container_Type">Packaging Container Description</label>
                                </div>
                        ...
                        <div class="col-md-6 mb-4">
                          ...
                          <?php if($data['ENVision_Disposal']) { ?>
                                <option <?php echo $data['ENVision_Disposal'] ?>><?php echo $data['ENVision_Disposal'] ?></option>
                              <?php } ?>
                              <option value="">Please Select</option>
                      ...
                      <fieldset>
                        ...
                        <div class="col-md-6 offset-md-3 mb-4">
                          <div class="form-label-group">
                            ...
                            <select id="Currency" name="Currency" class="form-control" autocomplete="off" data-parsley-group="fieldset03" required="">
                            <?php
                        ...
                        <div class="d-flex">
                          ...
                          <div id="test-l-4" class="content dstepper-none fade">
                            ...
                            <br><br>
                              ...
                              ?>
                                ...
                                <select id="RD_Codes_Treatment" name="RD_Codes_Treatment" data-toggle="selectpicker" data-width="100%" data-size="6" onchange="showCharityDonated()">
                                  <?php
                               ...
                               <div class="row">
                                ...
                                <!-- <div class="col-md-6 mb-4">
                                  <div class="form-label-group">
                                    <input type="text" id="Treatment_Method_Detail" class="form-control" name="Treatment_Method_Detail" value="<?php echo $data['Treatment_Method_Detail']; ?>" data-parsley-group="fieldset04" required=""> <label for="Treatment_Method_Detail">Treatment Method Detail</label>
                                  </div>
                                ...
                                <div class="form-group">
                                  ...
                                  $result = mysqli_query($db, $sql);
                                  echo "<option value='" . $data['Treatment_Method_Detail'] . "'>". $data['Treatment_Method_Detail'] . "</option>";
                                  echo "<option value=''>Please Select</option>";
                                  while ($row = mysqli_fetch_array($result)) {
                                    echo "<option value='" . $row['description'] . "'> " . $row['description'] . "</option>";
                                  }
                          ...
                          <!-- /grid column -->
                            ...
                            <label class="control-label" for="charity_donated_to">Charity Donated To</label>
                              ...
                              <?php
                                echo "<option value='" . $data['charity_donated_to'] . "'>". $data['charity_donated_to'] . "</option>";
                              ?>
                                <option value="">Please select</option>
                          ...
                          <div id="test-l-5" class="content dstepper-none fade">
                            ...
                            <fieldset>
                              ...
                              <div class="d-flex">
                             <!-- style="margin:auto" -->
                            <button type="button" class="prev btn btn-secondary">Previous</button><input type="submit" class="btn btn-success" value="Save">
                            </div>
                            <br><br>
                        ...
                        <div class="form-group mb-4">
                          ...
                          <textarea class="form-control" id="collections_comments" name="collections_comments" rows="3"><?php echo $data['collections_comments'] ?></textarea>
                        </div>
                        <!-- /grid column -->
                        ...
                        <?php echo "Documentation:" ?>
                            ...
                            <br>
                            <?php
                            $collectionsKey = $data['collections_key'];
                            $conn = mysqli_connect('46.22.129.7', 'apl_waste_user', 'Upl5o73?', 'apleona_waste');
                            $query3 = "SELECT file_name FROM collections_files WHERE collections_key='$collectionsKey'";
                            ...
                            $rows = mysqli_fetch_all($run3);
                                ...
                                <a class="btn btn-sm btn-icon btn-secondary far fa-trash-alt" href="<?php echo URLROOT; ?>/collections/delete_file?key=<?php echo $collectionsKey?>&file=<?php echo current($row)?>" onclick="confirmation(event)"></a>
