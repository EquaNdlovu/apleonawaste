      ...
      <div class="page-inner">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="optionModalLabel">Add Charity Donation Item</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form action="<?php echo URLROOT; ?>/Lookup_Charity_Donations/add" method="post">
                  ...
                  <div class="form-group">
                    <label for="avg_value">Average Value: <sup>*</sup></label>
                    <input type="number" name="avg_value" class="form-control form-control-lg <?php echo (!empty($data['avg_value_err'])) ? 'is-invalid' : ''; ?>">
                    <span class="invalid-feedback"><?php echo $data['avg_value_err']; ?></span>
                  </div>
        ...
        <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Edit Charity Donation Item</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form action="<?php echo URLROOT; ?>/Lookup_Charity_Donations/update" method="post">
                  <div class="form-group" style="display:none">
          ...
          <?php foreach ($data['lookup'] as $lookups) :
            if (($lookups->customer) == $_SESSION['customer_group']) { ?>
              <tr>
                ...
                <td><?php echo $lookups->avg_value; ?></td>
                ...
                <td style="text-align: center"><a type="button" class="btn btn-secondary" href="<?php echo URLROOT; ?>/Lookup_Charity_Donations/delete/<?php echo $lookups->lookup_key; ?>" onclick="confirmation(event)">Delete</a></td>
              </tr>
          <?php }
          endforeach; ?>
        </table>
