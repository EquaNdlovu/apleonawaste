...
<script>
        $(document).ready(function () {
            <?php
            echo "showGraph('" . $site ."', '" . $customer ."'); showGraph1('" . $site ."', '" . $customer ."'); showGraph2('" . $site ."', '" . $customer ."'); showGraph3('" . $site ."', '" . $customer ."'); showGraph4('" . $site ."', '" . $customer ."'); showGraph5('" . $site ."', '" . $customer ."');";
            ?>   
...
<script>
        $(document).ready(function () {
            <?php
            echo "showCharityGraph1('" . $site ."', '" . $customer ."'); showCharityGraph2('" . $site ."', '" . $customer ."'); showCharityGraph3('" . $site ."', '" . $customer ."');";
            ?>   
