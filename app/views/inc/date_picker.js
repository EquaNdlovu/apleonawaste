  ...
  function refreshScreen(site, customer, fullStartDate, fullEndDate)
        {
			...
			showGraph4(site, customer, fullStartDate, fullEndDate);
			showGraph5(site, customer, fullStartDate, fullEndDate);
			showCharityGraph1(site, customer, fullStartDate, fullEndDate);
			showCharityGraph2(site, customer, fullStartDate, fullEndDate);
			showCharityGraph3(site, customer, fullStartDate, fullEndDate);
			//console.log(refresh);
		...
		function updateDiv() {      
			...
			$( "#donationsDiv" ).load(location.href + " #donationsDiv" );
			//$( "#cubes" ).load(location.href + " #cubes" );
