<?php
  class Lookup_Material_Analysis_Details extends Controller {
    public function __construct(){
      $this->materialsModel = $this->model('Lookup_Material_Analysis_Detail');
    }
    ...
    public function index(){
        ...
        $this->view('Lookup_Material_Analysis_Details/index', $data);
      }
    ...
    public function add(){
      ...
      if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if($this->materialsModel->add($data)){
            ...
            redirect('Lookup_Material_Analysis_Details/index');
          } else {
        ...
        // Load view
        $this->view('Lookup_Material_Analysis_Details/add', $data);
      }
    }
    ...
    public function edit($lookup_key){
      ...
      $this->view('Lookup_Material_Analysis_Details/edit', $data);
