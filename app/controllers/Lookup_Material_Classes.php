<?php
  class Lookup_Material_Classes extends Controller {
    public function __construct(){
      $this->materialsModel = $this->model('Lookup_Material_Class');
    }
    ...
    public function index(){
        ...
        $this->view('Lookup_Material_Classes/index', $data);
      }
    ...
    public function add(){
      ...
      if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if($this->materialsModel->add($data)){
            ...
            redirect('Lookup_Material_Classes/index');
          } else {
        ...
        // Load view
        $this->view('Lookup_Material_Classes/add', $data);
      }
    }
    ...
    public function edit($lookup_key){
      ...
      $this->view('Lookup_Material_Classes/edit', $data);
